class year_calendar {
	...
	_language = '';
	_month_name_list = {'ru': ['Январь', 'Февраль', 'Март', 'Апрель', 'Май', 'Июнь', 'Июль', 'Август', 'Сентябрь', 'Октябрь', 'Ноябрь', 'Декабрь'],
	                   'en': ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']};
	_weekday_name_list = {'ru':['Пн','Вт','Ср','Чт','Пт','Сб','Вс'],
	                     'en':['Su','Mo','Tu','We','Th','Fr','Sa']};
	_first_day = {'ru': 1,
                 'en': 0};
				 
	_header = {'ru': 'Календарь на',
               'en': 'Calendar for'};
	_month_in_line = 4;
